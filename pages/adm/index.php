...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if ($action === 'save') {
            ...
            if ($name === '' || $email === '' || !in_array($profile, ['admin', 'financeiro', 'medico', 'enfermeiro', 'recepcao', 'cliente'], true)) throw new InvalidArgumentException('Nome, e-mail e perfil sao obrigatorios.');
            if ($id) {
...
echo '<h2>Usuarios</h2><table><tr><th>Nome</th><th>E-mail</th><th>Perfil</th><th>Status</th><th>Acoes</th></tr>';
